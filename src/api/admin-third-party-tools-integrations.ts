...
export const getGetExperimentSampleCallsUrl = (datasourceId: string,
    experimentId: string,) => {
...
export const getExperimentSampleCalls = async (datasourceId: string,
    experimentId: string, options?: RequestInit): Promise<GetExperimentSampleCalls200> => {
  
  return orvalFetch<GetExperimentSampleCalls200>(getGetExperimentSampleCallsUrl(datasourceId,experimentId),
  {      
    ...options,
    method: 'GET'
...
export const getGetExperimentSampleCallsKey = (datasourceId: string,
    experimentId: string,) => [`/v1/m/integrations/datasources/${datasourceId}/experiments/${experimentId}/sample-calls`] as const;

export type GetExperimentSampleCallsQueryResult = NonNullable<Awaited<ReturnType<typeof getExperimentSampleCalls>>>
export type GetExperimentSampleCallsQueryError = ErrorType<HTTPExceptionError | HTTPValidationError>

export const useGetExperimentSampleCalls = <TError = ErrorType<HTTPExceptionError | HTTPValidationError>>(
  datasourceId: string,
    experimentId: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getExperimentSampleCalls>>, TError> & { swrKey?: Key, enabled?: boolean }, request?: SecondParameter<typeof orvalFetch> }
) => {
  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false && !!(datasourceId && experimentId)
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getGetExperimentSampleCallsKey(datasourceId,experimentId) : null);
  const swrFn = () => getExperimentSampleCalls(datasourceId,experimentId, requestOptions)
...
export const setOrganizationTurnConnection = async (organizationId: string,
    setConnectionToTurnRequest: SetConnectionToTurnRequest, options?: RequestInit): Promise<AddWebhookToOrganizationResponse> => {
  
  return orvalFetch<AddWebhookToOrganizationResponse>(getSetOrganizationTurnConnectionUrl(organizationId),
  {      
    ...options,
    method: 'PUT',
...
export const getRegenerateTurnWebhookTokenUrl = (organizationId: string,
  ...
  return stringifiedParams.length > 0 ? `/v1/m/integrations/turn-connection/${organizationId}/regenerate-webhook-token?${stringifiedParams}` : `/v1/m/integrations/turn-connection/${organizationId}/regenerate-webhook-token`
}

export const regenerateTurnWebhookToken = async (organizationId: string,
    params?: RegenerateTurnWebhookTokenParams, options?: RequestInit): Promise<AddWebhookToOrganizationResponse> => {
  
  return orvalFetch<AddWebhookToOrganizationResponse>(getRegenerateTurnWebhookTokenUrl(organizationId,params),
  {      
    ...options,
    method: 'PUT'
...
export const getRegenerateTurnWebhookTokenMutationFetcher = (organizationId: string,
    params?: RegenerateTurnWebhookTokenParams, options?: SecondParameter<typeof orvalFetch>) => {
  return (_: Key, __: { arg: Arguments }) => {
    return regenerateTurnWebhookToken(organizationId, params, options);
  }
}
export const getRegenerateTurnWebhookTokenMutationKey = (organizationId: string,
    params?: RegenerateTurnWebhookTokenParams,) => [`/v1/m/integrations/turn-connection/${organizationId}/regenerate-webhook-token`, ...(params ? [params]: [])] as const;

export type RegenerateTurnWebhookTokenMutationResult = NonNullable<Awaited<ReturnType<typeof regenerateTurnWebhookToken>>>
export type RegenerateTurnWebhookTokenMutationError = ErrorType<HTTPExceptionError>

export const useRegenerateTurnWebhookToken = <TError = ErrorType<HTTPExceptionError>>(
  organizationId: string,
    params?: RegenerateTurnWebhookTokenParams, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof regenerateTurnWebhookToken>>, TError, Key, Arguments, Awaited<ReturnType<typeof regenerateTurnWebhookToken>>> & { swrKey?: string }, request?: SecondParameter<typeof orvalFetch>}
) => {

  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const swrKey = swrOptions?.swrKey ?? getRegenerateTurnWebhookTokenMutationKey(organizationId,params);
  const swrFn = getRegenerateTurnWebhookTokenMutationFetcher(organizationId,params, requestOptions);
